...
{
    public partial class identificationgestionnaire : Form
    {
        
        
        public identificationgestionnaire()
        {
            InitializeComponent();
        }
        ...
        //rendre invisible mon progressbar
        private void identificationgestionnaire_Load(object sender, EventArgs e)
        {
            progressBar1.Visible = false;
        }
        //fonction qui verifie la taille de mon mot de passe
        ...
        //boutton connexion
        private void p_connexion_Click(object sender, EventArgs e)
        {
                                         ...
                                         connexion.Open();
                                                 MySqlCommand commande = new MySqlCommand();                                                
                                                  ...
                                                  commande.CommandType = CommandType.Text;
                                                     commande.CommandText = "select login, pasword, priv from compte where priv =0";
        ...
        //code pour transformer le code en miniscule
